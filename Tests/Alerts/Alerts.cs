...
namespace TestProj.Tests.Alerts
{
    ...
    public class Alerts
    {
        ...
        /// 7. Click on <back to ctions> button
        /// TEST OUTPUT:
        ...
        ///   5.1 Select 0 - 25km  and select one wholesaler under that range by checbox
        ///   5.2 Select 25 - 50km  and select one wholesaler under that range by checbox
        ///   5.3 Select 50 - 75km  and select one wholesaler under that range by checbox
        ///   5.4  Select 75 - 100km  and select one wholesaler under that range by checbox
        ...
        /// 3.
        ///   3.1 The wholesaler records which are found are displayed as catalogue – outlet name  on the screen, with a 
        ///     location list sorted by group and grouped into groups on increments 25km
        /// 4.
        ...
        ///   3.1 Verify Checking Connection label is available, checking vital communication to the ordering service, 
        ///     connection speed, test your speed connection now
        ...
        ///   3.4 Verify that the results palce holder label is available
        ...
        /// 3.
        ///   3.1 The Checking Connection label is available, checking vital communication to the ordering service, 
        ///     connection speed, test your speed connection now  are displayed on the diagnose connection screen
        ...
        /// 3.  Select a different spaza from the list
        /// 4. Verify the following changes after a different spaza has been selected
        ///   4.1 Verify that the basket switches to the outlet specific basket
        ///   4.2 Verify that orders chages to  outlet specific orders(including invoices)
        ///   4.3 Verify that catalogues, favourites and messages remain the same
        /// TEST OUTPUT:
        /// 1. The " You have connection issues" text is highlighted in red
        /// 2. A list of spazas is displayed next to the alias name on top right hand corner
        /// 3. The Selected spaza is displayed
        /// 4.
        ///   4.1  The basket switches to the specific outlet
