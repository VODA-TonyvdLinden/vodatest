...
namespace TestProj.Classes.TestDataClasses
{
    public class BuildDefaultData
    {
        public void Go()
        {
            ...
            def.ActivationData = new Classes.TestDataClasses.Activation() { ActivationKey = "123456", Alias = "NUnit Tester", MSISDN = "0726629728", OTP = "195451", Username = "5212055461087", InvalidOTP = "INV123", ExpiredOPT = "EXP123" };
