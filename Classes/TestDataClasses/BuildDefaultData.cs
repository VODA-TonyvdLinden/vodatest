...
namespace TestProj.Classes.TestDataClasses
{
    public class BuildDefaultData
    {
        public void Go()
        {
            ...
            def.ActivationData = new Classes.TestDataClasses.Activation() { ActivationKey = "123456", Alias = "NUnit Tester", MSISDN = "0829985519", OTP = "151846", Username = "5212055461087", InvalidOTP = "INV123", ExpiredOPT = "EXP123", ChallengeQuestion = 4, ChallengeAnswer = "45" };
